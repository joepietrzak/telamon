...
Slots: `Header`, `Sidebar`, `Breadcrumbs`, `ConceptHeader`, `SourcesList`, `Toc`, `Backlinks`, `SearchBox`, `NotFound`, `Footer`. Define them outside render, or memoize them — a new function identity each render remounts that region.
